...
--
-- Host: localhost
-- Generation Time: Mar 12, 2013 at 06:26 PM
...
('a', '2003', 'Yes', 'q', 'q', 'q', 'q', '5', 'Yes'),
('ajeet', '', 'Yes', 'ai', 'iips', '1', 'adg', '54', 'Yes'),
('b', '', '', 'b', 'b', 'b', 'b', '2422', ''),
('n', '2003', 'Yes', 'b', 'b', 'b', 'bbj', '544', '-- Se'),
('n', '2003', 'Yes', 'nm', 'nm', 'nm', 'nm', '6757', 'Yes'),
('n', '2003', '-- Se', 'o', 'o', '5', 'o', '545', 'Yes'),
('n', '2003', 'Yes', 'tr', 't', 't', 't', '44', 'Yes'),
('n', '2003', 'No', 'w', 'w', '7', 'w', '54', 'No'),
('v', '2003', 'Yes', 'n', 'n', 'n', 'n', '25', 'Yes');
...
INSERT INTO `gen_info` (`User_Id`, `Gen_Info_Name`, `Gen_Info_Fname`, `Gen_Info_Mname`, `Gen_Info_Department`, `Gen_Info_CD`, `Gen_Info_GP`, `Gen_Info_DLP`, `Gen_Info_AFC`, `Gen_Info_PA`, `Gen_Info_TNO`, `Gen_Info_Email`) VALUES
('ajeet', 'Ajeet Khan', 'F Khan', 'S Khan', 'IIPS', 'Reader', 50000, '2012-12-09', 'Mhow, Indore', 'Mhow, Indore', 7869851872, 'akhan.iipsmca@gmail.com'),
('ic2k9', 'ggfgkgkg', 'k,vkgk', '111111111', 'qkvkvk', ',v,flk', 0, '2013-02-13', '', '', 0, ''),
('n', 'Nitesh', 'Scvsh', 'hvhvh', 'vhvh', 'h', 2111, '2013-02-12', 'bbhvhv', 'hvh', 1212, 'vg'),
('v', 'v', 'v', 'v', 'v', 'v', 20032003, '2013-02-12', 'n', 'n', 155445, 'nn');
...
--
-- Table structure for table `pbas_assets`
--

CREATE TABLE IF NOT EXISTS `pbas_assets` (
...
--
-- Dumping data for table `pbas_assets`
--

INSERT INTO `pbas_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `pbas_associations`
--

CREATE TABLE IF NOT EXISTS `pbas_associations` (
...
--
-- Table structure for table `pbas_banners`
--

CREATE TABLE IF NOT EXISTS `pbas_banners` (
...
--
-- Table structure for table `pbas_banner_clients`
--

CREATE TABLE IF NOT EXISTS `pbas_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `pbas_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `pbas_banner_tracks` (
...
--
-- Table structure for table `pbas_categories`
--

CREATE TABLE IF NOT EXISTS `pbas_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pbas_categories`
--

INSERT INTO `pbas_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `pbas_contact_details`
--

CREATE TABLE IF NOT EXISTS `pbas_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `pbas_content`
--

CREATE TABLE IF NOT EXISTS `pbas_content` (
...
--
-- Table structure for table `pbas_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `pbas_content_frontpage` (
...
--
-- Table structure for table `pbas_content_rating`
--

CREATE TABLE IF NOT EXISTS `pbas_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `pbas_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `pbas_core_log_searches` (
...
--
-- Table structure for table `pbas_extensions`
--

CREATE TABLE IF NOT EXISTS `pbas_extensions` (
...
--
-- Dumping data for table `pbas_extensions`
--

INSERT INTO `pbas_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `pbas_finder_filters`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_filters` (
...
--
-- Table structure for table `pbas_finder_links`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links` (
...
--
-- Table structure for table `pbas_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms0` (
...
--
-- Table structure for table `pbas_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `pbas_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `pbas_finder_taxonomy`
--

INSERT INTO `pbas_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `pbas_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pbas_finder_terms`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_terms` (
...
--
-- Table structure for table `pbas_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `pbas_finder_terms_common`
--

INSERT INTO `pbas_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `pbas_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `pbas_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pbas_finder_types`
--

CREATE TABLE IF NOT EXISTS `pbas_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `pbas_languages`
--

CREATE TABLE IF NOT EXISTS `pbas_languages` (
...
--
-- Dumping data for table `pbas_languages`
--

INSERT INTO `pbas_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `pbas_menu`
--

CREATE TABLE IF NOT EXISTS `pbas_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pbas_menu`
--

INSERT INTO `pbas_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `pbas_menu_types`
--

CREATE TABLE IF NOT EXISTS `pbas_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pbas_menu_types`
--

INSERT INTO `pbas_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `pbas_messages`
--

CREATE TABLE IF NOT EXISTS `pbas_messages` (
...
--
-- Table structure for table `pbas_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `pbas_messages_cfg` (
...
--
-- Table structure for table `pbas_modules`
--

CREATE TABLE IF NOT EXISTS `pbas_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pbas_modules`
--

INSERT INTO `pbas_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `pbas_modules_menu`
--

CREATE TABLE IF NOT EXISTS `pbas_modules_menu` (
...
--
-- Dumping data for table `pbas_modules_menu`
--

INSERT INTO `pbas_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `pbas_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `pbas_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `pbas_overrider`
--

CREATE TABLE IF NOT EXISTS `pbas_overrider` (
...
--
-- Table structure for table `pbas_redirect_links`
--

CREATE TABLE IF NOT EXISTS `pbas_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `pbas_schemas`
--

CREATE TABLE IF NOT EXISTS `pbas_schemas` (
...
--
-- Dumping data for table `pbas_schemas`
--

INSERT INTO `pbas_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.0.3');

-- --------------------------------------------------------

--
-- Table structure for table `pbas_session`
--

CREATE TABLE IF NOT EXISTS `pbas_session` (
...
--
-- Dumping data for table `pbas_session`
--

INSERT INTO `pbas_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('4qnmiakk3cg4d7bdq28b87ca21', 0, 1, '1361905997', '__default|a:8:{s:15:"session.counter";i:8;s:19:"session.timer.start";i:1361905859;s:18:"session.timer.last";i:1361905986;s:17:"session.timer.now";i:1361905997;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:12.0) Gecko/20100101 Firefox/12.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":1:{s:5:"users";O:8:"stdClass":1:{s:5:"login";O:8:"stdClass":1:{s:4:"form";O:8:"stdClass":2:{s:4:"data";a:1:{s:6:"return";s:50:"http://localhost/Joomla_3.0.3-Stable-Full_Package/";}s:6:"return";s:50:"http://localhost/Joomla_3.0.3-Stable-Full_Package/";}}}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"f18668bf5617cc123fea20e8d0c0f10c";}', 0, ''),
('rpq6asupoj599qamujjlil60k0', 1, 1, '1361905950', '__default|a:8:{s:15:"session.counter";i:5;s:19:"session.timer.start";i:1361905852;s:18:"session.timer.last";i:1361905950;s:17:"session.timer.now";i:1361905950;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:12.0) Gecko/20100101 Firefox/12.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":1:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";N;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";N;s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"8dac566aa6507e1bbe713ae6162d46e2";}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `pbas_template_styles`
--

CREATE TABLE IF NOT EXISTS `pbas_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pbas_template_styles`
--

INSERT INTO `pbas_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `pbas_updates`
--

CREATE TABLE IF NOT EXISTS `pbas_updates` (
...
--
-- Table structure for table `pbas_update_sites`
--

CREATE TABLE IF NOT EXISTS `pbas_update_sites` (
...
--
-- Dumping data for table `pbas_update_sites`
--

INSERT INTO `pbas_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
...
--
-- Table structure for table `pbas_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `pbas_update_sites_extensions` (
...
--
-- Dumping data for table `pbas_update_sites_extensions`
--

INSERT INTO `pbas_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `pbas_usergroups`
--

CREATE TABLE IF NOT EXISTS `pbas_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `pbas_usergroups`
--

INSERT INTO `pbas_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `pbas_users`
--

CREATE TABLE IF NOT EXISTS `pbas_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `pbas_users`
--

INSERT INTO `pbas_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(427, 'Super User', 'admin', 'balajicomputers@gmail.com', '7cce1c497246dc0561bf29327f3894a8:CfNO107cJMinBxc6IM1tARPa0Yp49coS', 0, 1, '2013-02-26 18:59:36', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `pbas_user_notes`
--

CREATE TABLE IF NOT EXISTS `pbas_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `pbas_user_profiles`
--

CREATE TABLE IF NOT EXISTS `pbas_user_profiles` (
...
--
-- Table structure for table `pbas_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `pbas_user_usergroup_map` (
...
--
-- Dumping data for table `pbas_user_usergroup_map`
--

INSERT INTO `pbas_user_usergroup_map` (`user_id`, `group_id`) VALUES
(427, 8);

-- --------------------------------------------------------

--
-- Table structure for table `pbas_viewlevels`
--

CREATE TABLE IF NOT EXISTS `pbas_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `pbas_viewlevels`
--

INSERT INTO `pbas_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `pbas_weblinks`
--

CREATE TABLE IF NOT EXISTS `pbas_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `teach_apb` (`User_Id`, `Year`, `Teach_APB_TNO`, `Teach_APB_BEP`, `Teach_APB_ISSN`, `Teach_APB_WPR`, `Teach_APB_NOC`, `Teach_APB_MA`, `Teach_APB_API`) VALUES
('n', '2003', 'b', 'b', 'b', 'b', 0, 'Yes', 10),
('n', '2003', 'j', 'j', 'j', 'j', 4, 'No', 45),
('n', '2003', 'n', 'n', 'n', 'n', 0, 'No', 5),
('n', '2003', 'o', 'o', 'o', 'o', 5, 'No', 45),
('n', '2003', 'u', 'u', 'u', 'u', 4, 'No', 15);
...
INSERT INTO `teach_bpe` (`User_Id`, `Year`, `Teach_BPE_TPN`, `Teach_BPE_TBA`, `Teach_BPE_PISSN`, `Teach_BPE_WPR`, `Teach_BPE_NOC`, `Teach_BPE_MA`, `Teach_BPE_API`) VALUES
('n', '2003', 'm', 'm', 'm', 'm', 0, 'No', 5),
('n', '2003', 'n', 'n', 'n', 'n', 0, 'No', 10);
...
CREATE TABLE IF NOT EXISTS `teach_clmi` (
  `User_Id` varchar(30) NOT NULL,
  `Year` varchar(10) NOT NULL,
  `Teach_CLMI_TOA` varchar(30) NOT NULL,
...
INSERT INTO `teach_cpc` (`User_Id`, `Year`, `Teach_CPC_Title`, `Teach_CPC_Agency`, `Teach_CPC_Period`, `Teach_CPC_GAM`, `Teach_CPC_WPD`, `Teach_CPC_API`) VALUES
('n', '2003', 'bb', 'b', 0, 0, 'b', 10),
('n', '2003', 'v', 'v', 0, 0, 'v', 5);
...
CREATE TABLE IF NOT EXISTS `teach_ecfa` (
  `User_Id` varchar(30) NOT NULL,
  `Year` varchar(10) NOT NULL,
  `Teach_ECFA_TOA` varchar(30) NOT NULL,
...
('a', '2003', 'a', '6', 5),
('a', '2003', 'ngehfnfnfjfnfjfgnvjcngmgmgkgkg', '25', 10),
('n', '2003', 'nb', 'nb', 10),
('n', '2003', 'workshop', '4', 65),
('v', '2003', 'v', '5', 5);
...
CREATE TABLE IF NOT EXISTS `teach_edap` (
  `User_Id` varchar(30) NOT NULL,
  `Year` varchar(10) NOT NULL,
  `Teach_EDAP_TED` varchar(50) NOT NULL,
...
INSERT INTO `teach_fcp` (`User_Id`, `Year`, `Teach_FCP_TNO`, `Teach_FCP_BEP`, `Teach_FCP_ISSN`, `Teach_FCP_NOC`, `Teach_FCP_MA`, `Teach_FCP_API`) VALUES
('n', '2003', 'bc', 'cb', 'c', 4, 'No', 4),
('n', '2003', 'm', 'm', 'm', 0, 'Yes', 2),
('n', '2003', 'o', 'o', 'o', 8, 'No', 8),
('n', '2003', 'p', 'p', 'p', 8, 'Yes', 5);
...
CREATE TABLE IF NOT EXISTS `teach_fdp` (
  `User_Id` varchar(30) NOT NULL,
  `Year` varchar(10) NOT NULL,
  `Teach_FDP_Programme` varchar(50) NOT NULL,
  `Teach_FDP_Duration` varchar(20) NOT NULL,
  `Teach_FDP_Organized` varchar(50) NOT NULL,
...
INSERT INTO `teach_fdp` (`User_Id`, `Year`, `Teach_FDP_Programme`, `Teach_FDP_Duration`, `Teach_FDP_Organized`, `Teach_FDP_API`) VALUES
('n', '2003', 'h', 'h', 'h', 5),
('n', '2003', 'nb', 'n', 'n', 10);
...
INSERT INTO `teach_ilc` (`User_Id`, `Year`, `Teach_ILC_TOL`, `Teach_ILC_TCS`, `Teach_ILC_DOE`, `Teach_ILC_Organized`, `Teach_ILC_WINS`, `Teach_ILC_API`) VALUES
('n', '2003', 'nb', 'n', '2013-01-01', 'n', 'International', 5),
('n', '2003', 'nm', 'm', '2013-01-02', 'mn', 'International', 10);
...
CREATE TABLE IF NOT EXISTS `teach_lstp` (
  `User_Id` varchar(30) NOT NULL,
  `Year` varchar(10) NOT NULL,
  `Teach_LSTP_Course` varchar(30) NOT NULL,
  `Teach_LSTP_Level` varchar(30) NOT NULL,
  `Teach_LSTP_MOT` varchar(30) NOT NULL,
  `Teach_LSTP_NOCA` int(11) NOT NULL,
  `Teach_LSTP_NOCC` int(11) NOT NULL,
  `Teach_LSTP_Practicals` varchar(30) NOT NULL,
  `Teach_LSTP_CTDR` int(11) NOT NULL,
...
('a', '2003', 'q', 'q', 'q', 2, 2, 'q', 12, 5, 10),
('n', '2003', 'n', 'n', 'n', 0, 0, 'n', 0, 2, 10),
('n', '2003', 'nm', 'nmnm', 'nm', 21, 22, '21', 12, 1, 9),
('n', '2003', 's', 's', 's', 0, 0, 's', 0, 2, 20),
('n', '2004', 'b', 'b', 'b', 2, 2, '2', 2, 2, 2),
('n', '2004', 'mk', 'mk', 'kh', 24, 4, '2', 2, 2, 2),
('n', '2004', 'nfnf', 'n', 'n', 0, 0, 'n', 0, 0, 0),
...
INSERT INTO `teach_opc` (`User_Id`, `Year`, `Teach_OPC_Title`, `Teach_OPC_Agency`, `Teach_OPC_Period`, `Teach_OPC_GAM`, `Teach_OPC_API`) VALUES
('n', '2003', 'b', 'b', 'b', 0, 10),
('n', '2003', 'n', 'n', 'n', 0, 5);
...
CREATE TABLE IF NOT EXISTS `teach_pda` (
  `User_Id` varchar(30) NOT NULL,
  `Year` varchar(10) NOT NULL,
  `Teach_PDA_TOA` varchar(50) NOT NULL,
...
INSERT INTO `teach_ppc` (`User_Id`, `Year`, `Teach_PPC_TPP`, `Teach_PPC_TCS`, `Teach_PPC_DOE`, `Teach_PPC_Organized`, `Teach_PPC_WINS`, `Teach_PPC_API`) VALUES
('n', '2003', 'm', 'm', '2013-01-07', 'm', 'National', 5),
('n', '2003', 'n', 'n', '2013-01-02', 'nf', 'International', 10);
...
INSERT INTO `teach_ppij` (`User_Id`, `Year`, `Teach_PPIJ_TNO`, `Teach_PPIJ_Journal`, `Teach_PPIJ_ISBN`, `Teach_PPIJ_PR`, `Teach_PPIJ_NCA`, `Teach_PPIJ_MA`, `Teach_PPIJ_API`) VALUES
('a', '2003', 'a', 'a', 'a', 'a', 2, 'Yes', 5),
('n', '2003', 'b', 'a', 'b', 'b', 3, 'Yes', 5),
('n', '2003', 'mn', 'm', 'm', 'm', 1, 'No', 5),
('n', '2003', 'n', 'n', 'n', 'n', 2, 'Yes', 10),
('n', '2003', 'q', 'q', 'q', 'q', 2, 'No', 10),
('n', '2003', 'w', '5', '5', 'ji', 5, 'Yes', 10),
('n', '2003', 'y', 'y', 'y', 'y', 8, 'No', 10);
...
INSERT INTO `teach_rg` (`User_Id`, `Year`, `Teach_RG_NE`, `Teach_RG_TS`, `Teach_RG_DA`, `Teach_RG_API`) VALUES
('n', '2003', 'm', 'm', 'm', 10),
('n', '2003', 'n', 'n', 'n', 5);
...
CREATE TABLE IF NOT EXISTS `teach_rimc` (
  `User_Id` varchar(30) NOT NULL,
  `Year` varchar(11) NOT NULL,
  `Teach_RIMC_Course` varchar(30) NOT NULL,
  `Teach_RIMC_Consulted` varchar(30) NOT NULL,
  `Teach_RIMC_Prescribed` varchar(30) NOT NULL,
  `Teach_RIMC_ARP` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `teach_tlm` (
  `User_Id` varchar(30) NOT NULL,
  `Year` varchar(11) NOT NULL,
  `Teach_TLM_SD` varchar(30) NOT NULL,
...
INSERT INTO `userinfo` (`User_Id`, `Pwd`) VALUES
('a', 'a'),
('ajeet', 'ajeet'),
('b', 'b'),
('c', 'c'),
